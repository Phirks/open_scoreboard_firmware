...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_NDEF_LAUNCHAPP_MSG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NFC_NDEF_LAUNCHAPP_REC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_OPEN_SCOREBOARD_NRF52832, 1);
